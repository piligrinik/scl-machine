...
SC_AGENT_IMPLEMENTATION(DirectInferenceAgent)
{
  ...
  ScAddr const formulasSet =
      utils::IteratorUtils::getAnyByOutRelation(&m_memoryCtx, actionNode, CoreKeynodes::rrel_2);
  ScAddr const arguments =
      utils::IteratorUtils::getAnyByOutRelation(&m_memoryCtx, actionNode, CoreKeynodes::rrel_3);
