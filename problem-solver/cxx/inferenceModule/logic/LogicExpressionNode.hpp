...
public:
  ...
  void setOutputStructureElements(
      std::unordered_set<ScAddr, ScAddrHashFunc<sc_uint64>> const & otherOutputStructureElements)
  {
...
protected:
  ...
  std::unordered_set<ScAddr, ScAddrHashFunc<sc_uint64>> outputStructureElements;
};
